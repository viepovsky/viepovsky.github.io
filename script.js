$(document).ready(function() {
  const apiRoot = 'https://tasks-prod-kodilla-tasks-0rsghx.mo4.mogenius.io/v1/tasks';
  const trelloApiRoot = 'https://tasks-prod-kodilla-tasks-0rsghx.mo4.mogenius.io/v1/trello';
