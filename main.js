...
function loadCities() {
  ...
  if (countrySelect.value) {
    ...
    fetch(`https://3.72.88.245/city-walk-app/localization/cities?country-code=${countryCode}`)
      .then(response => response.json())
      .then(data => {
...
function getWearRecommendation() {
  ...
  fetch(`https://3.72.88.245/city-walk-app/recommendation/wear?date=${today}&latitude=${latitude}&longitude=${longitude}`)
  .then(response => response.json())
  .then(data => {
...
function getWalkRecommendation() {
    ...
    fetch(`https://3.72.88.245/city-walk-app/recommendation/walk?latitude=${latitude}&longitude=${longitude}`)
    .then(response => response.json())
    .then(data => {
